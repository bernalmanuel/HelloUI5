		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "apphelloui5",
									"targetURL": "#p2cmodhelloui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"p2cmodhelloui5-display": {
								"semanticObject": "p2cmodhelloui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=p2c.modhelloui5",
									"url": sap.ui.require.toUrl("p2c/modhelloui5")
								}
							}
						}
					}
